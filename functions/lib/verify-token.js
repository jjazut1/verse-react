...
exports.testGetAssignmentForToken = exports.testVerifyTokenAndLogin = void 0;
const admin = require("firebase-admin");
const functions = require("firebase-functions");
const cors = require("cors");
const corsHandler = cors({ origin: true });
// HTTP function instead of callable function
exports.testVerifyTokenAndLogin = functions.https.onRequest((req, res) => {
...
// Function to get assignment details for an already used token - converted to HTTP
exports.testGetAssignmentForToken = functions.https.onRequest((req, res) => {
    corsHandler(req, res, async () => {
        try {
            const { token } = req.body;
            if (!token) {
